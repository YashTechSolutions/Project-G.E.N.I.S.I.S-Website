...
const Hero = () => {
    return (
        <div className="flex flex-col w-full h-screen gap-10 justify-center items-center ">
            ...
            <motion.h2 initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 1.2, duration: 2.5}}className=' text-1xl lg:text-3xl tracking-tight text-matrix-green '> <span className='text-neutral-100'>Guided </span>Executive Navigator and Intelligent System for Individual Support</motion.h2>
        </div>
    );
};
